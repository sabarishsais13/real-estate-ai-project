...
urlpatterns = [
    ...
    path('api/properties/track-interaction/', views.track_property_interaction, name='track_property_interaction'),
    ...
    path('property/<int:id>/edit/',    views.edit_property_page,   name='edit_property'),
